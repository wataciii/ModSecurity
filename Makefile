...
ACLOCAL = ${SHELL} /root/ModSecurity/build/missing aclocal-1.14
AMTAR = $${TAR-tar}
...
APXS = /usr/bin/apxs2
APXS_BINDIR = /usr/bin
APXS_CC = x86_64-linux-gnu-gcc -std=gnu99
...
AR = ar
AUTOCONF = ${SHELL} /root/ModSecurity/build/missing autoconf
AUTOHEADER = ${SHELL} /root/ModSecurity/build/missing autoheader
AUTOMAKE = ${SHELL} /root/ModSecurity/build/missing automake-1.14
AWK = mawk
CC = gcc
...
LIBXML2_CPPFLAGS = 
LIBXML2_LDADD = -L/usr/local/lib -lxml2 -lz -lm
LIBXML2_LDFLAGS = 
...
LUA_LDADD = 
LUA_LDFLAGS = 
MAKEINFO = ${SHELL} /root/ModSecurity/build/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
...
MODSEC_EXTRA_CFLAGS = -DWITH_PCRE_STUDY -DMODSEC_PCRE_MATCH_LIMIT=1500 -DMODSEC_PCRE_MATCH_LIMIT_RECURSION=1500  -DREQUEST_EARLY          -DWITH_APU_CRYPTO
MSC_BASE_DIR = /root/ModSecurity
MSC_PKGBASE_DIR = /root/ModSecurity/..
MSC_REGRESSION_CONF_DIR = /root/ModSecurity/tests/regression/server_root/conf
MSC_REGRESSION_DIR = /root/ModSecurity/tests/regression
MSC_REGRESSION_DOCROOT_DIR = /root/ModSecurity/tests/regression/server_root/htdocs
MSC_REGRESSION_LOGS_DIR = /root/ModSecurity/tests/regression/server_root/logs
MSC_REGRESSION_SERVERROOT_DIR = /root/ModSecurity/tests/regression/server_root
MSC_TEST_DIR = /root/ModSecurity/tests
NM = /usr/bin/nm -B
NMEDIT = 
OBJDUMP = objdump
OBJEXT = o
...
SSDEEP_LDFLAGS = 
STRIP = strip
TOPLEVEL_SUBDIRS = tools apache2
VERSION = 2.9
YAJL_CFLAGS = 
YAJL_LDADD = 
YAJL_LDFLAGS = 
YAJL_LIBS = 
abs_builddir = /root/ModSecurity
abs_srcdir = /root/ModSecurity
abs_top_builddir = /root/ModSecurity
abs_top_srcdir = /root/ModSecurity
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /root/ModSecurity/build/install-sh
